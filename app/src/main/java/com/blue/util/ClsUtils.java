...
//        cancelBondProcess(btClass, device);
    ...
    static public Object setPairingConfirmation(Class<?> btClass, BluetoothDevice device, boolean isConfirm) throws Exception {
    ...
    //设备蓝牙一定时间内可见
    public static void setDiscoverableTimeout(int timeout,BluetoothAdapter adapter) {
